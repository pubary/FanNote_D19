...
SECRET_KEY = 'django-insecure-3z9(&ppkh=ut$ki%)meiiug-=&-=d3+d%#oo@4)0wk9+c$ji^x'
...
WSGI_APPLICATION = 'fannote.wsgi.application'
...
# next is my additions

SITE_ID = 1

AUTH_USER_MODEL = 'users.FunUser'
LOGIN_URL = 'login'
